...
function Facebook()
{
	...
	function getInfo()
	{
		//var PARAMLIST={'ad_name_div':{'label':'Ad Name','comment':'名称'},'ad_name2_div':{'label':'广告名称','comment':'名称'},'ad_name3_div':{'class':'_2vl9 _1h1f','comment':'名称'},'website_url_div':{'label':'Website URL','comment':'名称'},'website_url2_div':{'label':'网址','comment':'名称'},'common_textarea':{'class':'_2vli _2vlj _1h26 _1h27','comment':'输入框'},'common.image_div':{'class':'_3-90','comment':'图像'},'account_span':{'class':'_55pe','comment':'当前账户信息'}};
		...
		if(!obj||!obj.parentElement.querySelector('textarea'))
			if(!(obj=getObjectFromDefine(PARAMLIST,null,'website_url2_div')[0])||!obj.parentElement.querySelector('textarea'))
				if(!(obj=getObjectFromDefine(PARAMLIST,null,'website_url3_div')[0])||!obj.parentElement.querySelector('textarea'))
					obj=getObjectFromDefine(PARAMLIST,null,'website_url4_textarea')[0];
