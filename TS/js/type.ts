...
//第一种形式 
var someValue1: any = "this is a string";
var strLength1: number = (<string>someValue1).length;
console.log(someValue1)
console.log(strLength1)

//第二种形式
var someValue2: any = "this is a string11111";
var isNull2: boolean = !!(someValue2 as string);
var strLength2: number = (someValue2 as string).length;
